...
describe('Footer', () => {
  ...
  it('renders disclaimer text', () => {
    render(<Footer />);
    expect(screen.getByText('Information only. Not individualized legal advice.')).toBeInTheDocument();
  });
  ...
  it('displays translated disclaimer', () => {
    ...
    render(<Footer />);
    expect(screen.getByText('Nur Information – keine individuelle Rechtsberatung.')).toBeInTheDocument();
  });
