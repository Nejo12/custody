...
export default function UpdatePrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-xl rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-3 flex items-center justify-between text-sm text-zinc-500 dark:text-zinc-400 shadow-lg">
      ...
      <div className="flex items-center gap-2 ml-4">
        ...
        <button
          className="rounded border border-zinc-300 dark:border-zinc-700 bg-zinc-900 dark:bg-zinc-100 px-3 py-1 text-sm text-white dark:text-zinc-700 hover:bg-zinc-800 dark:hover:bg-zinc-200"
