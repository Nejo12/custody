    ...
    <div className="w-full">
      ...
      <AnimatedHero>
        <div className="space-y-6">
          ...
          <Link
            href="/interview"
            className="inline-block rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-700 px-6 py-3 text-center font-medium hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-black dark:hover:bg-white transition-colors"
          >
