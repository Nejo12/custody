const en = {
  ...
  home: {
    ...
    motionEnabled: "Motion off — tap to enable",
    motionDisabled: "Prefer calm? Disable animations",
    learn: "Learn the Law",
    ...
    outcome: {
      ...
      title: "See what you’ll walk away with",
      subtitle:
        "You get more than a score. Each answer shapes the PDF pack, timeline, and checklist you can use immediately.",
      previewHeader: "Preview",
      previewPrimary: "Joint custody status with § references",
      previewSecondary: "Court cover letter pre-filled",
      previewTertiary: "Checklist with deadlines & documents",
      cardStatus: "Status",
      cardStatusValue: "Eligible for joint custody",
      cardStatusCopy: "Includes §1626a BGB reference and your stated facts.",
      cardChecklist: "Checklist",
      cardItemOne: "Book Jugendamt appointment",
      cardItemTwo: "Bring IDs + birth certificate",
      cardItemThree: "Print & sign cover letter",
      documentsTag: "Court-ready PDF",
      documentsTitle: "Personalized filings with the right § references",
      documentsDescription:
        "Download a clean PDF pack with cover letter, attachments checklist, and the citations you need.",
      checklistTag: "Checklist",
      checklistTitle: "Step-by-step actions that fit your situation",
      checklistDescription:
        "See what to do this week, who to call, and what to bring to Jugendamt or court.",
      timelineTag: "Timeline",
      timelineTitle: "Timeline that keeps you on track",
      timelineDescription:
        "Key dates, reminders, and optional calendar export so you never miss a filing window.",
    },
    story: {
      eyebrow: "Why this exists",
      title: "I built this after being kept from my kids",
      body: "I went months without seeing my children because I didn’t know the exact steps. This tool removes guesswork: the right § references, the right forms, the right sequence.",
      note: "If you’re overwhelmed, start with the interview. You’ll leave with next steps you can act on today.",
    },
    proof: {
      legal: "Built on German family law (BGB)",
      legalDescription:
        "Each outcome cites the relevant §§ so you can speak with Jugendamt or court confidently.",
      accessibility: "WCAG AA, multilingual, offline-ready",
    ...
    heroPreview: {
      header: "Outcome preview",
      lead: "The interview builds these artifacts as you answer. No stock screenshots—real, ready-to-use pieces.",
      packTitle: "Court-ready PDF pack",
      packLineOne: "Cover letter with § references",
      packLineTwo: "Attachments checklist",
      packLineThree: "Signature-ready download",
      timelineTitle: "Action timeline",
      timelineLineOne: "Book Jugendamt visit",
      timelineLineTwo: "Print + sign cover letter",
      timelineLineThree: "Calendar reminders included",
      timeline: "Timeline & reminders",
      timelineCopy: "Key dates, deadlines, and a simple sequence you can follow without a lawyer.",
    },
    ...
    feature6MinutesDescription: "Quick and straightforward questions to understand your situation",
  ...
  planning: {
    ...
    guidesForThisStage: "Guides for This Stage",
    guide: "guide",
    guides: "guides",
    noGuidesAvailable: "No guides available for this stage yet.",
    checkBackSoon: "Check back soon as we add more content!",
    requiredDocuments: "Required Documents",
    getPersonalizedPlanDescription: "Answer a few questions to get your customized checklist",
    interactiveChecklist: "Interactive Checklist",
    interactiveChecklistDescription: "Track your progress through essential legal steps",
    interactiveChecklistDescriptionShort: "Track your progress through essential steps",
    findResourcesDescription: "Jugendamt and Standesamt locations near you",
    findResourcesDescriptionShort: "Jugendamt and Standesamt near you",
    cta: {
    ...
    checklist: {
      ...
      shareDescription: "Create a shareable link to show your progress to your partner or advisor.",
      tip: "Tip",
      progressTip:
    ...
    documentTemplates: {
      ...
      description: "Download fillable templates for common custody-related forms",
      vaterschaftsanerkennung: "Vaterschaftsanerkennung (Paternity Acknowledgment)",
      sorgerechtserklaerung: "Sorgeerklärung (Joint Custody Declaration)",
      kindergeldChecklist: "Kindergeld Application Checklist",
      emergencyCustody: "Emergency Custody Declaration",
      coparentingAgreement: "Co-Parenting Agreement Outline",
      downloadTemplate: "Download Template",
      generateTemplate: "Generate Template",
      fillForm: "Fill out the form and bring it to Jugendamt or Standesamt",
    },
    personalizedTool: {
      ...
      results: {
        ...
        description: "Based on your situation, here's your personalized action plan",
    ...
    cityResources: {
      ...
      cityNotFoundTip: "Can't find your city? These are sample resources for major cities.",
      cityNotFoundHelp:
